...
using EF.DbContextFactory.Examples.SimpleInjector.Models;

namespace EF.DbContextFactory.Examples.SimpleInjector.Controllers
{
    [HandleError]
    public class HomeController : Controller
    {
        private readonly OrderRepositoryWithFactory _orderRepository;

        public HomeController(OrderRepositoryWithFactory orderRepository)
        {
